...
const clients = [
  { id: "1", name: "Sarah Johnson", phone: "+1 234-567-8901" },
  { id: "2", name: "Michael Chen", phone: "+1 234-567-8902" },
  { id: "3", name: "Emily Davis", phone: "+1 234-567-8903" },
  { id: "4", name: "James Wilson", phone: "+1 234-567-8904" },
  { id: "5", name: "Lisa Anderson", phone: "+1 234-567-8905" },
]

const services = [
  { id: "1", name: "Haircut", price: 45, duration: "45m" },
  { id: "2", name: "Hair Coloring", price: 120, duration: "2h" },
  { id: "3", name: "Manicure", price: 35, duration: "45m" },
  { id: "4", name: "Pedicure", price: 45, duration: "1h" },
  { id: "5", name: "Beard Trim", price: 20, duration: "20m" },
  { id: "6", name: "Balayage", price: 180, duration: "2.5h" },
]
